...
public class TemplateClassInitializer implements NodeInitializer
{
    ...
    public void initialize(IElement element)
    {
        ...
        {
            IClassifier classifer = (IClassifier) element;
            
            Object value = FactoryRetriever.instance().createType("ParameterableElement", 
                                                                  null);
            if (value != null && value instanceof IParameterableElement)
            {
                classifer.addTemplateParameter((IParameterableElement) value);
            }
        }
