 ...
 *
 */
public class InterfaceRoleInitializer implements NodeInitializer
{
    ...
    public void initialize(IElement element)
    {
        ...
        {
            IParameterableElement pParamEle = (IParameterableElement)element;
            pParamEle.setTypeConstraint("Interface");
            if (element instanceof IClassifier)
            {
                ((IClassifier)element).setIsAbstract(true);
            }
        }
    }
