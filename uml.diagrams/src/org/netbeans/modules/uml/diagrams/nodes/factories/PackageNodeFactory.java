...
import org.netbeans.modules.uml.diagrams.nodes.PackageWidget;
import org.netbeans.modules.uml.drawingarea.NodeWidgetFactory;

/**
 *
 */
public class PackageNodeFactory implements NodeWidgetFactory
{

    public Widget createNode(Scene scene)
    {
        return new PackageWidget(scene);
    }
}
