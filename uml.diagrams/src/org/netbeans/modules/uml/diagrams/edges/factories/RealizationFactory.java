 ...
 *
 */
public class RealizationFactory extends AbstractRelationshipFactory
{

    public RealizationFactory()
    {
    }
    ...
    public IRelationship create(IElement source, IElement target)
    {
        ...
        if((source instanceof INamedElement) && (target instanceof INamedElement))
        {
            retVal = factory.createDependency2((INamedElement)source, 
    ...
    public void reconnectSource(IElement relationship, IElement source)
    {
           ...
           (source instanceof INamedElement))
        {
            ...
            dependency.setClient((INamedElement)source);
        }
    }
    ...
    public void reconnectTarget(IElement relationship, IElement target)
    {
        ...
        {
            IDependency dependency = (IDependency)relationship;
            dependency.setSupplier((INamedElement)target);
        }
    }
