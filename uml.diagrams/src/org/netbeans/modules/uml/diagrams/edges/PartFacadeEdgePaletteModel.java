 ...
 * 
 */
public class PartFacadeEdgePaletteModel implements ContextPaletteButtonModel
{
    ...
    public PartFacadeEdgePaletteModel()
    {
        
    }
    
    public PartFacadeEdgePaletteModel(Image  image,
                                       String tooltip)
    {
        setImage(image);
        setTooltip(tooltip);
    ...
    public WidgetAction[] createActions(Scene scene)
    {
        ...
        if(scene instanceof DesignerScene)
        {
            ...
            PartFacadeEdgeConnectProvider connector = new PartFacadeEdgeConnectProvider("");
