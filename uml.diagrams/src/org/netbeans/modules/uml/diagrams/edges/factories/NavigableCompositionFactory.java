...
public class NavigableCompositionFactory extends AssociationFactory
{

    public NavigableCompositionFactory()
    {
    }
    ...
    public IRelationship create(IElement source, IElement target)
    {
        ...
        if((source instanceof IClassifier) && (target instanceof IClassifier))
        {
            ...
            retVal = factory.createAssociation2(sourceClassifier, 
                                                targetClassifier, 
