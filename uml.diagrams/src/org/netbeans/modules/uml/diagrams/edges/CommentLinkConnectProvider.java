 ...
 * 
 */
public class CommentLinkConnectProvider extends SceneConnectProvider
{
    
    public CommentLinkConnectProvider(String defaultType)
    {
        super(defaultType, "");
    }
    ...
    public ConnectorState isTargetWidget(Widget sourceWidget, Widget targetWidget)
    {
        ...
        if(sourceWidget.getScene() instanceof ObjectScene)
        {
            ...
            if((source != null) && (target != null))
            {
                ...
                if(sourceElement instanceof IComment)
                {
                ...
                else if(sourceElement instanceof INamedElement)
                {
                    if(targetElement instanceof IComment)
                    {
                        retVal = ConnectorState.ACCEPT;
                    }
                }
    ...
    public void createConnection(Widget sourceWidget, Widget targetWidget)
    {
        if(sourceWidget.getScene() instanceof GraphScene)
        {
            ...
            if((source != null) && (target != null))
            {
                ...
                if(sourceElement instanceof IComment)
                {
                    comment = (IComment)sourceElement;
                    if(targetElement instanceof INamedElement)
                    {
                       annotated = (INamedElement)targetElement;
                    }
                }
                else if(sourceElement instanceof INamedElement)
                {
                    if(targetElement instanceof IComment)
                    {
                        if(targetElement instanceof INamedElement)
                        {
                            comment = (IComment)targetElement;
                            annotated = (INamedElement)sourceElement;
                        }
                    }
                }
                
                if((comment != null) && (annotated != null))
                {
                    comment.addAnnotatedElement(annotated);
                    
                    IPresentationElement edge = createNodePresentationElement(comment);
