...
import org.netbeans.modules.uml.diagrams.actions.sqd.DestroyLifelineAction;
...
public class DestroyLifelineRapidButtonDescription implements ContextPaletteButtonModel
{
    ...
    public DestroyLifelineRapidButtonDescription()
    {
        
    }
    
    public DestroyLifelineRapidButtonDescription(Image  image,
                                  String tooltip)
    {
        setImage(image);
    ...
    public WidgetAction[] createActions(Scene scene)
    {
        ...
        if(scene instanceof DesignerScene)
        {
            ...
            WidgetAction action = new DestroyLifelineAction();
