...
public class ToggleShowReturnMessages extends SceneNodeAction
{
    ...
    public ToggleShowReturnMessages()
    {
        super();
    }
    ...
    protected void performAction(Node[] activatedNodes)
    {
        ...
        engine.setSettingValue(SequenceDiagramEngine.SHOW_RETURN_MESSAGES, engine.getSettingValue(SequenceDiagramEngine.SHOW_RETURN_MESSAGES)==Boolean.FALSE);
    }
    ...
    {
        return NbBundle.getMessage(ToggleShowReturnMessages.class, "LBL_SHOW_RETURN_MESSAGES");
    }
    ...
    {   
        ...
        SequenceDiagramEngine engine=(SequenceDiagramEngine) scene.getEngine();
        item.setSelected(engine.getSettingValue(SequenceDiagramEngine.SHOW_RETURN_MESSAGES)==Boolean.TRUE);
