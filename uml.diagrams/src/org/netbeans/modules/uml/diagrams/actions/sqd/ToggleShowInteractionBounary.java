...
public class ToggleShowInteractionBounary extends SceneNodeAction
{
    ...
    public ToggleShowInteractionBounary()
    {
        super();
    }
    ...
    {
        return NbBundle.getMessage(ToggleShowInteractionBounary.class, "LBL_SHOW_INTERACTION_BOUNDARY");
    }
    ...
    {   
        ...
        SequenceDiagramEngine engine=(SequenceDiagramEngine) scene.getEngine();
        item.setSelected(engine.getSettingValue(SequenceDiagramEngine.SHOW_INTERACTION_BOUNDARY)==Boolean.TRUE);
