...
abstract class MultipleGradientPaintContext implements PaintContext
{
            ...
            throws NoninvertibleTransformException
    {
        ...
        model = coerceColorModel(dataModel, cm.isAlphaPremultiplied());
    }
            ...
            (Color [] loColors, Color [] hiColors, float Imin)
    {
        ...
        for(int i=0; i < gradients.length; i++)
        {
            ...
            System.out.println("nGradients = " + nGradients);
    ...
    public final Raster getRaster(int x, int y, int w, int h)
    {
        ...
        coerceData(raster, dataModel, model.isAlphaPremultiplied());
     ...
     */
    public ColorModel coerceColorModel(ColorModel cm, boolean newAlphaPreMult) 
    {
     ...
     */
    public ColorModel coerceData(WritableRaster wr, ColorModel cm, boolean newAlphaPreMult) 
    {
    ...
    protected void multiplyAlpha(WritableRaster wr)
    {
    ...
    protected void divideAlpha(WritableRaster wr)
    {
        if (is_BYTE_COMP_Data(wr.getSampleModel()))
    ...
    private boolean is_BYTE_COMP_Data(SampleModel sm)
    {
        // Check ColorModel is of type DirectColorModel
    ...
    protected void divide_BYTE_COMP_Data(WritableRaster wr)
    {
        ...
        for (int y=0; y<wr.getHeight(); y++)
        {
            ...
            while (sp < end)
            {
                ...
                {         // this does NOT include a == 255 (0xff) !
    ...
    protected void mult_BYTE_COMP_Data(WritableRaster wr)
    {
        // System.out.println("Multiply Int: " + wr);
    ...
    protected void mult_INT_PACK_Data(WritableRaster wr)
    {
        // System.out.println("Multiply Int: " + wr);
