...
public class CreateSequenceDiagramFromMultipleNodes extends PerformanceTestCase {
    ...
    /** Creates a new instance of CreateSequenceDiagramFromMultipleNodes */
    public CreateSequenceDiagramFromMultipleNodes(String testName) {
        super(testName);
        expectedTime = 5000;
    ...
    public void prepare() {
        ...
        diag_type.selectItem("Sequence Diagram");
...
//        junit.textui.TestRunner.run(new CreateSequenceDiagramFromMultipleNodes("measureTime"));
//    }
}
