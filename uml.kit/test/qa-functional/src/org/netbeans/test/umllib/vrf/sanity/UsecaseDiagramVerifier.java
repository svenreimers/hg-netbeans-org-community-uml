 ...
 *
 */
public class UsecaseDiagramVerifier extends AbstractDiagramVerifier{
    //String[] elements =
    /** Creates a new instance of ClassDiagramVerifier */
    public UsecaseDiagramVerifier(String diagramName) {
        super(diagramName);
    }
    
    
    public UsecaseDiagramVerifier(String diagramName, PrintStream log) {
        super(diagramName, log);
    }
    
    public UsecaseDiagramVerifier(String diagramName, PrintStream log, String prefix) {
