 ...
 *
 */
public class DeploymentDiagramVerifier extends AbstractDiagramVerifier{
    //String[] elements =
    /** Creates a new instance of ClassDiagramVerifier */
    public DeploymentDiagramVerifier(String diagramName) {
        super(diagramName);
    }
    
    
    public DeploymentDiagramVerifier(String diagramName, PrintStream log) {
        super(diagramName, log);
    }
    
    public DeploymentDiagramVerifier(String diagramName, PrintStream log, String prefix) {
    ...
    protected ElementTypes[] getSupportedElements() {
        return new ElementTypes[] { ElementTypes.COMPONENT,
                ElementTypes.INTERFACE,
                ElementTypes.PACKAGE,
                ElementTypes.ARTIFACT,
                ElementTypes.NODE,
                ElementTypes.DEPLOYMENT_SPECIFICATION             
        };
    }
