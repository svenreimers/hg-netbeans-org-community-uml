...
public class InterfaceElem extends JavaElem implements IInterfaceElem {
    ...
    public InterfaceElem(String name, IPackageElem pack, IInterfaceElem... superInterface) {
	super(name, pack);
	
	for(IInterfaceElem interfaceElem : superInterface){
	    this.superInterfaceList.add(interfaceElem);
	}
	
    }
    
    public ElemType getType() {
	return ElemType.INTERFACE;
    }
