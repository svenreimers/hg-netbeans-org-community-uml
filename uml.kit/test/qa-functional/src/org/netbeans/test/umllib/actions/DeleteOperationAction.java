 ...
 *
 * Created on May 12, 2005, 5:34 PM
 *
...
public class DeleteOperationAction extends DiagramElementAction{
    ...
    private static final Shortcut deleteOperationShortcut = new Shortcut(KeyEvent.VK_C, KeyEvent.CTRL_DOWN_MASK);
    
    
    
    /** Creates a new instance of DeleteOperationAction */
    public DeleteOperationAction() {
        super(null, actionPopup, deleteOperationShortcut);
    }
