...
public class UsecaseOperator extends DiagramElementOperator{
        
    
    
    public UsecaseOperator(DiagramOperator diagramOperator, String elementVN) throws NotFoundException {        
        super(diagramOperator, new ElementByVNChooser(elementVN, ElementTypes.USE_CASE), 0);        
    }
    
    public UsecaseOperator(DiagramOperator diagramOperator, String elementVN, int index) throws NotFoundException {
        super(diagramOperator, new ElementByVNChooser(elementVN, ElementTypes.USE_CASE), index);        
    }
    
    public UsecaseOperator(DiagramOperator diagramOperator, DiagramElementChooser elementFinder, int index) throws NotFoundException {
