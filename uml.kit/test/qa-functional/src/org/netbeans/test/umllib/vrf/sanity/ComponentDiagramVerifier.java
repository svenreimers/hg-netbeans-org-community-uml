...
public class ComponentDiagramVerifier extends AbstractDiagramVerifier{
    //String[] elements = 
    /** Creates a new instance of ComponentDiagramVerifier */
    public ComponentDiagramVerifier(String diagramName) {
        super(diagramName);
    }

    
    public ComponentDiagramVerifier(String diagramName, PrintStream log) {
        super(diagramName, log);
    }
    
    public ComponentDiagramVerifier(String diagramName, PrintStream log, String prefix) {
