...
package org.netbeans.test.uml.integration;
 ...
 */
public class TestBundle extends UMLTestCase {

    private ProjectsTabOperator pto;

    private JTreeOperator prTree;
    ...
    public TestBundle(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.integration.TestBundle.class);
        return suite;
    }
