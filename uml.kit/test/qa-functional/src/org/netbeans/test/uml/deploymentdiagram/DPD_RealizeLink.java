...
public class DPD_RealizeLink extends UMLTestCase {
    ...
    public DPD_RealizeLink(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_RealizeLink.class);
        return suite;
    }
...
/**
 * @caseblock Realize link
 * @usecase Invert selection of a Realize link
 */
...
/**
 * @caseblock Realize link
 * @usecase Find target element of a Realize link
 */
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.REALIZE, "", getLog());
    }
