...
public class TestEditControlPI extends UMLTestCase {
    
    private static String prName= "EditControlClassPlInd";
    ...
    private static String opStr3=operationVisibility3+" "+operationName3+"( "+parameterName3+" : "+parameterType3+" )"+" : "+operationRetType3;
    //--
    ...
    private static String atStr6_1=attributeVisibility6+" "+attributeName6_1+" : "+attributeType6+" = "+attributeDefValue6;
    private static String atStr6_2=attributeVisibility6+" "+attributeName6_2+" : "+attributeType6+" = "+attributeDefValue6;
    //--
    ...
    private static String opStr8_1=operationVisibility8+" "+operationName8_1+"( "+parameterName8+" : "+parameterType8+" )"+" : "+operationRetType8;
    private static String opStr8_2=operationVisibility8+" "+operationName8_2+"( "+parameterName8+" : "+parameterType8+" )"+" : "+operationRetType8;
    //--
    ...
    private static String atStr12=attributeVisibility12+" "+attributeName12+" : "+attributeType12+" = "+attributeDefValue12;
    ...
    private static String atStr13=defaultAttributeVisibility+" "+defaultNewElementName+" : "+defaultAttributeType;
    ...
    private static String opStrTmp14=operationVisibility14+" "+"( "+parameterName14+" : "+parameterType14+" ) : "+operationRetType14;
    //--
    ...
    private static String opStr15=operationVisibility15+" "+defaultNewElementName+"(  )"+" : "+operationRetType15;
    ...
    private static String attributeVisibility21[] = {defaultAttributeVisibility,defaultAttributeVisibility,defaultAttributeVisibility,defaultAttributeVisibility,"+"};
    private static String atStr21[]=new String[5];
    {for(int i=0;i<5;i++)atStr21[i]=attributeVisibility21[i]+" "+attributeName21[i]+" : "+attributeType21[i]+(attributeDefValue21[i].equals("")?"":(" = "+attributeDefValue21[i]));}
    //--
    ...
    private static String operationParameters22[] = {"","","","","f : int"};
    private static String operationVisibility22[] = {defaultOperationVisibility,defaultOperationVisibility,defaultOperationVisibility,defaultOperationVisibility,"-"};
    private static String opStr22[]=new String[5];
    {for(int i=0;i<5;i++)opStr22[i]=operationVisibility22[i]+" "+operationName22[i]+"( "+operationParameters22[i]+" )"+" : "+operationRetType22[i];}
    //--
    ...
    private static String attributeVisibility23_1 = "-";
    private static String attributeVisibility23_2 = "+";
    private static String atStr23_1=attributeVisibility23_1+" "+attributeName23+" : "+attributeType23+" = "+attributeDefValue23;
    private static String atStr23_2=attributeVisibility23_2+" "+attributeName23+" : "+attributeType23+" = "+attributeDefValue23;
    //--
    ...
    private static String atStr24_1=attributeVisibility24+" "+attributeName24+" : "+attributeType24_1+" = "+attributeDefValue24;
    private static String atStr24_2=attributeVisibility24+" "+attributeName24+" : "+attributeType24_2+" = "+attributeDefValue24;
    //--
    ...
    private static String atStr25_1=attributeVisibility25+" "+attributeName25+" : "+attributeType25+" = "+attributeDefValue25_1;
    private static String atStr25_2=attributeVisibility25+" "+attributeName25+" : "+attributeType25+" = "+attributeDefValue25_2;
    //--
    ...
    private static String operationVisibility26_2 = "-";
    private static String operationVisibility26_1 = "+";
    private static String opStr26_1=operationVisibility26_1+" "+operationName26+"( "+parameterName26+" : "+parameterType26+" )"+" : "+operationRetType26;
    private static String opStr26_2=operationVisibility26_2+" "+operationName26+"( "+parameterName26+" : "+parameterType26+" )"+" : "+operationRetType26;
    //--
    ...
    private static String operationParameters27_1="f : int";
    private static String operationParameters27_2 = "f_modified : int, g : double";
    private static String operationVisibility27 = defaultOperationVisibility;
    private static String opStr27_1=operationVisibility27+" "+operationName27+"( "+operationParameters27_1+" )"+" : "+operationRetType27;
    private static String opStr27_2=operationVisibility27+" "+operationName27+"( "+operationParameters27_2+" )"+" : "+operationRetType27;
    //--
...
private static String operationName28  = "operation28";
    ...
    private static String opStr28_1=operationVisibility28+" "+operationName28+"( "+parameterName28+" : "+parameterType28+" )"+" : "+operationRetType28_1;
    private static String opStr28_2=operationVisibility28+" "+operationName28+"( "+parameterName28+" : "+parameterType28+" )"+" : "+operationRetType28_2;
    
    
    /** Need to be defined because of JUnit */
    public TestEditControlPI(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.editcontrol.TestEditControlPI.class);       
        return suite;
    }
...
/**
    ...
    public void testDropAndName() {
        ...
        try {
            ...
            fail("Can't find new unnamed class on the diagram");
        }
        //
        ...
        {
            fail("Can't name element/ no edit control appears after naming start");
        }
...
/**
    ...
    public void testAttributeInsertAndName() {
        ...
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(null,attributeType2,attributeName2,attributeDefValue2);
...
/**
    ...
    public void testOperationInsertAndName() {
        ...
        try {
            ...
            fail("Unable to find operation compartment");
        }
        ...
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(null, operationRetType3, operationName3, parameterType3,parameterName3);
        //check text in textfield
...
/**
    ...
    public void testAttributeRenameWithDoubleclick() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(null,attributeType6,attributeName6_1,attributeDefValue6);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        //-replace name
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(null,attributeType6,attributeName6_2,attributeDefValue6);
...
/**
    ...
    public void testAttributeNameWithDoubleclick() {
        ...
        //------------
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(null,attributeType7,attributeName7,attributeDefValue7);
        //--
        //try to find edit control
        org.netbeans.test.umllib.EditControlOperator ec=new org.netbeans.test.umllib.EditControlOperator();
        //
...
/**
    ...
    public void testOperationRenameWithDoubleclick() {
        ...
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(null, operationRetType8, operationName8_1, parameterType8,parameterName8);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        //-replace name
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(null, operationRetType8, operationName8_2, parameterType8,parameterName8);
...
/**
    ...
    public void testOperationNameWithDoubleclick() {
        ...
        oprCmp.clickOnCenter(2,InputEvent.BUTTON1_MASK);
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(null, operationRetType9, operationName9, parameterType9,parameterName9);
        //try to find edit control
        org.netbeans.test.umllib.EditControlOperator ec=new org.netbeans.test.umllib.EditControlOperator();
        //
        JTextFieldOperator tOp=ec.getTextFieldOperator();
...
/**
    ...
    public void testDeleteAttributeNameWithDoubleClick() {
        ...
        //----------------
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(null,attributeType12,attributeName12,attributeDefValue12);
         //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
       ...
       assertTrue("BLOCKING: Attribute \""+modAt+"\" in model isn't correctly propagated,should be \""+atStr12+"\"",atStr12.equals(modAt));
        ...
        //-delete name
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(null,attributeType12,"",attributeDefValue12);
...
/**
    ...
    public void testDeleteAttributeNameUnnamedWithDoubleClick() {
       ...
       DiagramOperator d = createOrOpenDiagram(project,workPkg13, classDiagramName13);
        ...
        //-delete name
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(null,null,"");
...
/**
    ...
    public void testDeleteOperationNameWithDoubleClick() {
        ...
        CompartmentOperator opComp=null;
            opComp=new CompartmentOperator(clE,CompartmentTypes.OPERATION_LIST_COMPARTMENT);
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(null, operationRetType14, operationName14, parameterType14,parameterName14);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        //-delete name
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(null, operationRetType14, "", parameterType14,parameterName14);
        //
...
/**
    ...
    public void testDeleteOperationNameUnnamedWithDoubleClick() {
        ...
        //-delete name
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(null, null, "");
        //
...
/**
    ...
    public void testMultipleAttributeInsertWithInsert() {
        ...
        for(int i=0;i<atComp.getCompartments().size();i++) {
            if(atComp.getCompartments().get(i).getName().equals(defaultAttributeVisibility+" "+defaultNewElementName+" : "+defaultAttributeType))good_count++;
        }
    ...
    public void testMultipleOperationInsertWithInsert() {
       ...
       DiagramOperator d = createOrOpenDiagram(project,workPkg20, classDiagramName20);
        ...
        for(int i=0;i<opComp.getCompartments().size();i++) {
            if(opComp.getCompartments().get(i).getName().equals(defaultOperationVisibility+" "+defaultNewElementName+"(  )"+" : "+defaultReturnType))good_count++;
        }
...
/**
    ...
    public void testDeleteMultipleAttributes() {
        ...
        for(int iA=0;iA<5;iA++) {
            atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
            new EventTool().waitNoEvent(500);
            org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility21[iA],attributeType21[iA],attributeName21[iA],attributeDefValue21[iA],true);
            new EventTool().waitNoEvent(500);
        }
        JemmyProperties.setCurrentOutput(defTestOut);
        try
...
/**
    ...
    public void testDeleteMultipleOperations() {
        ...
        for(int iA=0;iA<5;iA++) {
            opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
            new EventTool().waitNoEvent(500);
            org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility22[iA], operationRetType22[iA], operationName22[iA], operationParameters22[iA],true);
            new EventTool().waitNoEvent(500);
        }
        //
        int good_count=0;
        ...
        for(int i=0,opN=0;i<opComp.getCompartments().size();i++) {
            ...
            if(tmp.indexOf("+ "+className22+"(")==-1 && tmp.indexOf("finalize(")==-1) {
...
/**
    ...
    public void testChangeAttributeVisibility() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility23_1,attributeType23,attributeName23,attributeDefValue23);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        //-replace name
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility23_2,attributeType23,attributeName23,attributeDefValue23);
...
/**
   ...
   public void testChangeAttributeType() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility24,attributeType24_1,attributeName24,attributeDefValue24);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
       ...
       assertTrue("Attribute \""+modAt+"\" in model isn't correctly propagated,should be \""+atStr24_1+"\"",atStr24_1.equals(modAt));
        ...
        //-replace name
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility24,attributeType24_2,attributeName24,attributeDefValue24);
...
/**
   ...
   public void testChangeAttributeInitialValue() {
        ...
        atComp.getPopup().pushMenu(PopupConstants.INSERT_ATTRIBUTE);
        //delete name and default type int
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility25,attributeType25,attributeName25,attributeDefValue25_1);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        //-replace name
        org.netbeans.test.uml.editcontrol.utils.Utils.attributeNaturalWayNamingPI(attributeVisibility25,attributeType25,attributeName25,attributeDefValue25_2);
...
/**
    ...
    public void testChangeOperationVisibility() {
        ...
        CompartmentOperator opComp=null;
            opComp=new CompartmentOperator(clE,CompartmentTypes.OPERATION_LIST_COMPARTMENT);
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility26_1, operationRetType26, operationName26, parameterType26,parameterName26);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        //-replace name
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility26_2, operationRetType26, operationName26, parameterType26,parameterName26);
...
/**
    ...
    public void testChangeOperationParameters() {
        ...
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility27, operationRetType27, operationName27, operationParameters27_1);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        //-replace name
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility27, operationRetType27, operationName27, operationParameters27_2);
...
/**
    ...
    public void testChangeOperationReturntype() {
        ...
        opComp.getPopup().pushMenu(PopupConstants.INSERT_OPERATION);
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility28, operationRetType28_1, operationName28, parameterType28,parameterName28);
        //
        java.awt.Point a=drAr.getFreePoint();
        drAr.clickMouse(a.x,a.y,1);
        new EventTool().waitNoEvent(500);
        ...
        //-replace name
        org.netbeans.test.uml.editcontrol.utils.Utils.operationNaturalWayNamingPI(operationVisibility28, operationRetType28_2, operationName28, parameterType28,parameterName28);
