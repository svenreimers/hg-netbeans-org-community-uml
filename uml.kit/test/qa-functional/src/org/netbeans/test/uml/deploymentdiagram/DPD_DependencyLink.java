...
public class DPD_DependencyLink extends UMLTestCase {
    ...
    public DPD_DependencyLink(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_DependencyLink.class);
        return suite;
    }
...
/**
 * @caseblock Dependency link
 * @usecase Invert selection of a Dependency link
 */
...
/**
 * @caseblock Dependency link
 * @usecase Find target element of a Dependency link
 */
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.DEPENDENCY, "", getLog());
    }
