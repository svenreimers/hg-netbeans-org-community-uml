...
public class DiagramContextMenus_STD extends UMLTestCase {
    ...
    public DiagramContextMenus_STD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramcontextmenu.DiagramContextMenus_STD.class);
        return suite;
    }
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DCMUtils.openDiagram(prName, stdName, NewDiagramWizardOperator.STATE_DIAGRAM, workDir);
        if (diagram == null){
