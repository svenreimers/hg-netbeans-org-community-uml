...
public class DPD_AbstractionLink extends UMLTestCase {
    ...
    public DPD_AbstractionLink(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_AbstractionLink.class);
        return suite;
    }
...
/**
 * @caseblock Abstraction link
 * @usecase Invert selection of a Abstraction link
 */
...
/**
 * @caseblock Abstraction link
 * @usecase Find target element of a Abstraction link
 */
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.ABSTRACTION, "", getLog());
    }
