 ...
 */
public class DiagramToolbarButtons_UCD extends UMLTestCase {
    private static String prName = "UMLProjectDTlbBtn";
    private static String ucdName = "DUsecase";
    ...
    public DiagramToolbarButtons_UCD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramtoolbarbuttons.DiagramToolbarButtons_UCD.class);
        return suite;
    }
 ...
 * @usecase Check toolbar buttons of use case diagram
 */
 ...
 */
    public void testBtn_SequenceLayout(){
        ...
        try
        {
            ...
            fail("unexpected "+btnTooltipName+ " usecase diagram.");
        }
        catch(org.netbeans.test.umllib.exceptions.NotFoundException exc)
        {
            //good
        }
    }
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DTBUtils.openDiagram(prName, ucdName, NewDiagramWizardOperator.USECASE_DIAGRAM, workDir);
        if (diagram == null){
            fail("Can't open diagram '" + ucdName + "', project '" + prName + "'.");
        }
    }
