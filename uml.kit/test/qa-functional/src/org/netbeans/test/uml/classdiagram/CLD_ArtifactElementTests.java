 ...
 *
 * Created on May 13, 2005, 3:48 PM
 *
...
public class CLD_ArtifactElementTests extends ClassDiagramTestCase {
    ...
    public CLD_ArtifactElementTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.classdiagram.CLD_ArtifactElementTests.class);
        return suite;
    }
    ...
    public static void main(java.lang.String[] args) {
        ...
        junit.textui.TestRunner.run(new org.netbeans.test.uml.classdiagram.CLD_ArtifactElementTests("testCopyAndPasteClassElement"));
    }
    ...
    public void testSelectAllSimilar() throws NotFoundException {
        boolean result = verifier.checkSelectAllSimilar(new ElementTypes[]{ElementTypes.ARTIFACT, ElementTypes.CLASS});
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testHideChildrenOneLevel() throws NotFoundException {
        boolean result = verifier.checkHideChildrenOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.CLASS);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testHideChildrenAllLevels() throws NotFoundException {
        boolean result = verifier.checkHideChildrenAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.CLASS);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testHideParentsOneLevel() throws NotFoundException {
        boolean result = verifier.checkHideParentsOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.ARTIFACT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testHideParentsAllLevels() throws NotFoundException {
        boolean result = verifier.checkHideParentsAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.ARTIFACT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }   
    ...
    public void testShowChildrenOneLevel() throws NotFoundException {
        boolean result = verifier.checkShowChildrenOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.ARTIFACT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }   
    ...
    public void testShowChildrenAllLevels() throws NotFoundException {
        boolean result = verifier.checkShowChildrenAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.ARTIFACT);
        if (!result){
    ...
    public void testShowParentsOneLevel() throws NotFoundException {
        boolean result = verifier.checkShowParentsOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.ARTIFACT);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }   
    ...
    public void testShowParentsAllLevels() throws NotFoundException {
        boolean result = verifier.checkShowParentsAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.ARTIFACT);
        if (!result){
            fail(78350, "Test failed. Details in log file.");
        }
    }   
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new DiagramElementVerifier(diagram, ElementTypes.ARTIFACT, "CLD_", getLog());
    }
