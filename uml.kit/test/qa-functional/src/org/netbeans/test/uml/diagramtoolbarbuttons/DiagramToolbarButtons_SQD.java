...
public class DiagramToolbarButtons_SQD extends UMLTestCase {
    ...
    public DiagramToolbarButtons_SQD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramtoolbarbuttons.DiagramToolbarButtons_SQD.class);
        return suite;
    }
 ...
 */
    public void testBtn_HierarchicalLayout(){
        ...
        {
            JToggleButton btn = diagram.toolbar().getToggleButtonByTooltip(btnTooltipName);
            fail("unexpected "+btnTooltipName+ " sequence diagram.");
        }
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DTBUtils.openDiagram(prName, sqdName, NewDiagramWizardOperator.SEQUENCE_DIAGRAM, workDir);
        if (diagram == null){
