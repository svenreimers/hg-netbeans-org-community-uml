 ...
 */
public class DiagramToolbarButtons_COD extends UMLTestCase {
    ...
    public DiagramToolbarButtons_COD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramtoolbarbuttons.DiagramToolbarButtons_COD.class);
        return suite;
    }
 ...
 */
    public void testBtn_SequenceLayout(){
        ...
        try
        {
            ...
            fail("unexpected "+btnTooltipName+" on collaboration diagram.");
        }
        catch(Exception ex)
        {
            //good
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DTBUtils.openDiagram(prName, codName, NewDiagramWizardOperator.COLLABORATION_DIAGRAM, workDir);
        if (diagram == null){
