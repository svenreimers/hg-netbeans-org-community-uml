 ...
 *
 * Created on May 13, 2005, 4:26 PM
 *
 ...
 *
 */
public class CLD_PermissionLinkTests extends ClassDiagramTestCase {
    
    private static String prName = "UMLProjectForPermissionLink";
    private static String dpdName = "ClassDiagramForPermissionLink";
    ...
    public CLD_PermissionLinkTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.classdiagram.CLD_PermissionLinkTests.class);
        return suite;
    }
/** Use for execution inside IDE */
    public static void main(java.lang.String[] args) {
        ...
        junit.textui.TestRunner.run(new org.netbeans.test.uml.classdiagram.CLD_PermissionLinkTests("testDeleteByPopup"));
    }
//------------------------------------------------------------------------------    
    ...
    public void testSelectAllByPopup() throws NotFoundException {
        boolean result = verifier.checkSelectAllByPopup(ElementTypes.CLASS, ElementTypes.NODE, LinkTypes.PERMISSION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testInvertSelection() throws NotFoundException {
        boolean result = verifier.checkInvertSelection(ElementTypes.CLASS, ElementTypes.ARTIFACT, LinkTypes.PERMISSION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.PERMISSION, "CLD_", getLog());
    }
