...
/*
 * ClassElementTests.java
 *
 * Created on May 6, 2005, 4:01 PM
 *
...
public class CLD_ClassElementTests extends ClassDiagramTestCase {
    ...
    private static String prName = "UMLProjectForClassElement";
    private static String dpdName = "ClassDiagramForClassElement";
    ...
    public CLD_ClassElementTests(String name) {
        super(name);
    }
    ...
    public void testHideChildrenAllLevels() throws NotFoundException {
        boolean result = verifier.checkHideChildrenAllLevels(2, 2, LinkTypes.GENERALIZATION, ElementTypes.CLASS);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testHideParentsOneLevel() throws NotFoundException {
        boolean result = verifier.checkHideParentsOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.CLASS);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testHideParentsAllLevels() throws NotFoundException {
        boolean result = verifier.checkHideParentsAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.CLASS);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }   
    ...
    public void testShowChildrenOneLevel() throws NotFoundException {
        boolean result = verifier.checkShowChildrenOneLevel(2, 2, LinkTypes.GENERALIZATION, ElementTypes.CLASS);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }   
    ...
    public void testShowChildrenAllLevels() throws NotFoundException {
        boolean result = verifier.checkShowChildrenAllLevels(2, 2, LinkTypes.GENERALIZATION, ElementTypes.CLASS);
        if (!result){
    ...
    public void testShowParentsOneLevel() throws NotFoundException {
        boolean result = verifier.checkShowParentsOneLevel(2, 2, LinkTypes.DEPENDENCY, ElementTypes.CLASS);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }   
    ...
    public void testShowParentsAllLevels() throws NotFoundException {
        boolean result = verifier.checkShowParentsAllLevels(2, 2, LinkTypes.DEPENDENCY, ElementTypes.CLASS);
        if (!result){
            fail(78350, "Test failed. Details in log file.");
        }
    }   
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new DiagramElementVerifier(diagram, ElementTypes.CLASS, "CLD_", getLog());
    }
