...
package org.netbeans.test.uml.activitydiagram.utils;
...
public class Utils {
    ...
    public static void setDefaultPreferences() {
        ...
        new JButtonOperator(op, "Project Location:").push();
    }

    public static void commonActivityDiagramSetup(String workdir, String prName) {
