...
public class CLD_AbstractionLinkTests extends ClassDiagramTestCase {
    ...
    public CLD_AbstractionLinkTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.classdiagram.CLD_AbstractionLinkTests.class);
        return suite;
    }
...
//------------------------------------------------------------------------------    
    ...
    public void testSelectAllByPopup() throws NotFoundException {
        boolean result = verifier.checkSelectAllByPopup(ElementTypes.CLASS, ElementTypes.NODE, LinkTypes.ABSTRACTION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testInvertSelection() throws NotFoundException {
        boolean result = verifier.checkInvertSelection(ElementTypes.CLASS, ElementTypes.ARTIFACT, LinkTypes.ABSTRACTION);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.ABSTRACTION, "CLD_", getLog());
    }
