...
public class ActivityDiagramPlaceAndDeleteByKey extends UMLTestCase {
    ...
    private static String prName= "ActivityDiagramProjectPDK";
    ...
    public ActivityDiagramPlaceAndDeleteByKey(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.activitydiagram.ActivityDiagramPlaceAndDeleteByKey.class);
        return suite;
    }
