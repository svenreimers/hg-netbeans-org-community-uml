...
public class PlaceDeleteLinksByDel extends UMLTestCase {
    ...
    private static String prName= "componentDiagramProjectLDK";
...
/*private static String componentDiagramName15 = "cpD15";
    ...
    public PlaceDeleteLinksByDel(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.componentdiagram.PlaceDeleteLinksByDel.class);
        return suite;
    }
...
/*public void testDeleteLinkByKey5() {
  ...
  public void testDeleteLinkByKey11() {
        lastTestCase=getCurrentTestMethodName();
  ...
  public void testDeleteLinkByKey12() {
        lastTestCase=getCurrentTestMethodName();
