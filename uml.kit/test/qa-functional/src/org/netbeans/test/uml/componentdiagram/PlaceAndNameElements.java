...
public class PlaceAndNameElements extends UMLTestCase {
    ...
    private static String prName= "ComponentDiagramProjectNE";
   ...
   /* private static String diagramName15 = "cpD15";
    ...
    public PlaceAndNameElements(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.componentdiagram.PlaceAndNameElements.class);
        return suite;
    }
   ...
   private void testElementPlaceAndName(String workPkg,String diagramName,String element,String elementName,ElementTypes elementType,String newName)
   {
        ...
        try {
            ...
            fail("BLOCKING: Can't find '"+element+"' in palette");
        }
        //
