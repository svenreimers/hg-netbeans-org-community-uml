 ...
 *
 * Created on May 13, 2005, 4:30 PM
 *
...
public class CLD_RealizeLinkTests extends ClassDiagramTestCase {
    ...
    public CLD_RealizeLinkTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.classdiagram.CLD_RealizeLinkTests.class);
        return suite;
    }
/** Use for execution inside IDE */
    public static void main(java.lang.String[] args) {
        ...
        junit.textui.TestRunner.run(new org.netbeans.test.uml.classdiagram.CLD_RealizeLinkTests("testCopyAndPasteClassElement"));
    }
//------------------------------------------------------------------------------    
    ...
    public void testSelectAllByPopup() throws NotFoundException {
        boolean result = verifier.checkSelectAllByPopup(ElementTypes.CLASS, ElementTypes.NODE, LinkTypes.REALIZE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testInvertSelection() throws NotFoundException {
        boolean result = verifier.checkInvertSelection(ElementTypes.CLASS, ElementTypes.ARTIFACT, LinkTypes.REALIZE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.REALIZE, "CLD_", getLog());
    }
