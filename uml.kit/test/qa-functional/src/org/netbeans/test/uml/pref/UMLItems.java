...
public class UMLItems extends UMLTestCase {
    ...
    private static String[][] items={{"UML","Automatically Hide Modeling Window","Show Aliases","Prompt to Save Diagram","Prompt to Save Project","Don't Show Filter Warning Dialog"}};
