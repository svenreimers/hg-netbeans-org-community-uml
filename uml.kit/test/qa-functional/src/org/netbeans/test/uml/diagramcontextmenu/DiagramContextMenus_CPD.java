 ...
 */
public class DiagramContextMenus_CPD extends UMLTestCase {
    ...
    public DiagramContextMenus_CPD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramcontextmenu.DiagramContextMenus_CPD.class);
        return suite;
    }
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DCMUtils.openDiagram(prName, cpdName, NewDiagramWizardOperator.COMPONENT_DIAGRAM, workDir);
        if (diagram == null){
