...
public class ComponentElementsCDFSTests extends UMLTestCase {
    
    private EventTool eventTool = new EventTool();
    
    
    public ComponentElementsCDFSTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(ComponentElementsCDFSTests.class);
        return suite;
    }
    ...
    public void testCDFSArtifact(){
        ...
        final String DIA_NAME = "Cmp_Artft";
...
/*
    ...
    public void testCDFSComponent(){
        final String PATH_TO_OBJ = "Model|elmComponent";
        final String OBJ_NAME = "elmComponent";
        final String DIA_NAME = "Cmp_Cmpnt";
        final String DIA_PATH = "Model|"+DIA_NAME;
        util = new CDFSUtil(PROJECT_NAME, this);
...
/*
    ...
    public void tearDown() {
        ...
        try {
            DiagramOperator d=new DiagramOperator("Cmp");
            d.closeAllDocuments();
