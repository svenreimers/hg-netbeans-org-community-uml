...
public class ActivityDiagramElementsFromTree extends UMLTestCase {
    ...
    private static String prName= "ActivityDiagramProjectFT";
    ...
    public ActivityDiagramElementsFromTree(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.activitydiagram.ActivityDiagramElementsFromTree.class);
        return suite;
    }
