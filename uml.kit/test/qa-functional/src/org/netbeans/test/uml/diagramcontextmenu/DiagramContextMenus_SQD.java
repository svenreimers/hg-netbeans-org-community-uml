 ...
 */
public class DiagramContextMenus_SQD extends UMLTestCase {
    ...
    public DiagramContextMenus_SQD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramcontextmenu.DiagramContextMenus_SQD.class);
        return suite;
    }
 ...
 * @usecase Check context menu of sequense diagram
 */
    public void testItemLayoutSequence(){
        lastTestCase=getCurrentTestMethodName();
        String itemName = DCMUtils.DiagramPopupConstants.LAYOUT + "|" + DCMUtils.DiagramPopupConstants.LAYOUT_SEQUENCE;
        JMenuItemOperator item = DCMUtils.checkDiagramPopupMenuItem(diagram, itemName);
        if(item==null){
            fail("Diagram popum menu item '" + itemName + "' not found");
        }else if(!item.isEnabled()){
 ...
 * @usecase Check context menu of sequense diagram
 */
    public void testItemShowAllReturnMessages(){
        lastTestCase=getCurrentTestMethodName();
        String itemName = DCMUtils.DiagramPopupConstants.SHOW_ALL_RETURN_MESSAGES;
        JMenuItemOperator item = DCMUtils.checkDiagramPopupMenuItem(diagram, itemName);
        if(item==null){
            fail("Diagram popum menu item '" + itemName + "' not found");
        }else if(!item.isEnabled()){
 ...
 * @usecase Check context menu of sequense diagram
 */
    public void testItemShowMessageNumbers(){
        lastTestCase=getCurrentTestMethodName();
        String itemName = DCMUtils.DiagramPopupConstants.SHOW_MESSAGE_NUMBERS;
        JMenuItemOperator item = DCMUtils.checkDiagramPopupMenuItem(diagram, itemName);
        if(item==null){
            fail("Diagram popum menu item '" + itemName + "' not found");
        }else if(!item.isEnabled()){
 ...
 * @usecase Check context menu of sequense diagram
 */
    public void testItemShowInteractionBoundary(){
        lastTestCase=getCurrentTestMethodName();
        String itemName = DCMUtils.DiagramPopupConstants.SHOW_INTERACTION_BOUNDARY;
        JMenuItemOperator item = DCMUtils.checkDiagramPopupMenuItem(diagram, itemName);
        if(item==null){
            fail("Diagram popum menu item '" + itemName + "' not found");
        }else if(!item.isEnabled()){
 ...
 */
    public void testCheckUnnecessaryItems(){
        ...
        String[] itemsNecessary = new String[]{
            ...
            DCMUtils.DiagramPopupConstants.LAYOUT + "|" + DCMUtils.DiagramPopupConstants.LAYOUT_SEQUENCE,
            ...
            DCMUtils.DiagramPopupConstants.SHOW_ALL_RETURN_MESSAGES,
            DCMUtils.DiagramPopupConstants.SHOW_MESSAGE_NUMBERS,
            DCMUtils.DiagramPopupConstants.SHOW_INTERACTION_BOUNDARY
        };
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DCMUtils.openDiagram(prName, sqdName, NewDiagramWizardOperator.SEQUENCE_DIAGRAM, workDir);
        if (diagram == null){
            fail("Can't open diagram '" + sqdName + "', project '" + prName + "'.");
        }
    }
