...
public class DPD_PermissionLink extends UMLTestCase {
    ...
    public DPD_PermissionLink(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_PermissionLink.class);
        return suite;
    }
...
/**
 * @caseblock Permission link
 * @usecase Invert selection of a Permission link
 */
...
/**
 * @caseblock Permission link
 * @usecase Find target element of a Permission link
 */
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.PERMISSION, "", getLog());
    }
