...
public class PlaceAndDeleteByKey extends UMLTestCase {
    ...
    private static String prName= "ComponentDiagramProjectDK";
...
/* private static String diagramName15 = "cpD15";
    ...
    public PlaceAndDeleteByKey(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.componentdiagram.PlaceAndDeleteByKey.class);
        return suite;
    }
   ...
   private void testElementPlaceAndDelete(String workPkg,String diagramName,String element,String elementName,ElementTypes elementType,String newName)
   {
       ...
       //
        ...
        try{rbt=new java.awt.Robot();}catch(Exception ex){}
        rbt.keyPress(KeyEvent.VK_DELETE);
        rbt.keyRelease(KeyEvent.VK_DELETE);
        //Action.Shortcut shtc=new Action.Shortcut(KeyEvent.VK_DELETE);
        //new Action(null,null,shtc).performShortcut();
        //
        ...
        //
        assertTrue("Element wasn't deleted frm diagram",dEl.waitForDeletion(d, new DiagramElementOperator.ElementByVNChooser(newName,elementType),0));
        //
