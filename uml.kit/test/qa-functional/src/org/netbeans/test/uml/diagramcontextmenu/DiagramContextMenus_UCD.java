 ...
 */
public class DiagramContextMenus_UCD extends UMLTestCase {
    ...
    public DiagramContextMenus_UCD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramcontextmenu.DiagramContextMenus_UCD.class);
        return suite;
    }
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DCMUtils.openDiagram(prName, ucdName, NewDiagramWizardOperator.USECASE_DIAGRAM, workDir);
        if (diagram == null){
