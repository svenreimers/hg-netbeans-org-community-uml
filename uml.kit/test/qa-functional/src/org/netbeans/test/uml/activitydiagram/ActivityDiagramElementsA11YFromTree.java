...
public class ActivityDiagramElementsA11YFromTree extends UMLTestCase {
    ...
    private static String prName= "ActivityDiagramProjectFTA11Y";
    ...
    public ActivityDiagramElementsA11YFromTree(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.activitydiagram.ActivityDiagramElementsA11YFromTree.class);
        return suite;
    }
    ...
    public void testCreate21() {
        ...
        testElementPlaceFromTree("b_"+workPkg1,activityDiagramName1,element1,elementName1,elementType1);
    }
    public void testCreate22() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg2,activityDiagramName2,element2,elementName2,elementType2);
    }
    public void testCreate23() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg3,activityDiagramName3,element3,elementName3,elementType3);
    }
    public void testCreate24() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg4,activityDiagramName4,element4,elementName4,elementType4);
    }
    public void testCreate25() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg5,activityDiagramName5,element5,elementName5,elementType5);
    }
    public void testCreate26() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg6,activityDiagramName6,element6,elementName6,elementType6);
    }
    public void testCreate27() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg7,activityDiagramName7,element7,elementName7,elementType7);
    }
    public void testCreate28() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg8,activityDiagramName8,element8,elementName8,elementType8);
    }
    public void testCreate29() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg9,activityDiagramName9,element9,elementName9,elementType9);
    }
    public void testCreate30() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg10,activityDiagramName10,element10,elementName10,elementType10);
    }
   public void testCreate31() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg11,activityDiagramName11,element11,elementName11,elementType11);
    }
   public void testCreate32() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg12,activityDiagramName12,element12,elementName12,elementType12);
    }
   public void testCreate33() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg13,activityDiagramName13,element13,elementName13,elementType13);
    }
   public void testCreate34() {
        lastTestCase=getCurrentTestMethodName();
        testElementPlaceFromTree("b_"+workPkg14,activityDiagramName14,element14,elementName14,elementType14);
    }
   ...
   {
       //assertFalse("sunos is unsupported platform for drag/drop tests",System.getProperty("os.name").toLowerCase().indexOf("sunos")>-1);
       testElementPlace(workPkg,diagramName+"_first",element,elementName,elementType);
       Node de=new Node(lastDiagramNode,lastDiagramNode.getChildren().length-1);
        try{
            DiagramOperator dClose=new DiagramOperator("acD");
        ...
        DiagramOperator d = createDiagram(project,workPkg, diagramName+"_second");
        //
        int numChild=lastDiagramNode.getChildren().length;
        de.select();
        de.tree().waitSelected(de.getTreePath());
        de.tree().pushKey(KeyEvent.VK_ENTER,KeyEvent.CTRL_MASK);
        ...
        catch(Exception ex)
        {
            try
            {
                fail(element+" wasn't added to diagram, but object with type:"+new DiagramElementOperator(d,elementName).getType()+": and element type :"+new DiagramElementOperator(d,elementName).getElementType()+": was added while type should be :"+elementType+": was added");
            }
            catch(Exception ex2)
            {
