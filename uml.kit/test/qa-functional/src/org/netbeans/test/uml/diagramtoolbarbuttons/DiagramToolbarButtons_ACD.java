 ...
 */
public class DiagramToolbarButtons_ACD extends UMLTestCase {
    private static String prName = "UMLProjectDTlbBtn";
    private static String acdName = "DActivity";
    ...
    public DiagramToolbarButtons_ACD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramtoolbarbuttons.DiagramToolbarButtons_ACD.class);
        return suite;
    }
...
/**
 * @caseblock Activity Diagram
 * @usecase Check toolbar buttons of activity diagram
 */
 ...
 */
    public void testBtn_SequenceLayout(){
        ...
        try
        {
            diagram.toolbar().getToggleButtonByTooltip(btnTooltipName);
            fail("unexpected "+btnTooltipName+" on activity diagram.");
        }
        catch(Exception ex)
        {
            //good
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DTBUtils.openDiagram(prName, acdName, NewDiagramWizardOperator.ACTIVITY_DIAGRAM, workDir);
        if (diagram == null){
            fail("Can't open diagram '" + acdName + "', project '" + prName + "'.");
        }
    }
