 ...
 */
public class DiagramToolbarButtons_STD extends UMLTestCase {
    ...
    public DiagramToolbarButtons_STD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramtoolbarbuttons.DiagramToolbarButtons_STD.class);
        return suite;
    }
 ...
 * @usecase Check toolbar buttons of state diagram
 */
 ...
 */
    public void testBtn_SequenceLayout(){
        ...
        try
        {
            ...
            fail("unexpected "+btnTooltipName+ " state diagram.");
        }
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DTBUtils.openDiagram(prName, stdName, NewDiagramWizardOperator.STATE_DIAGRAM, workDir);
        if (diagram == null){
            fail("Can't open diagram '" + stdName + "', project '" + prName + "'.");
        }
    }
