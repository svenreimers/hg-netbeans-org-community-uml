...
public class DPD_Artifact extends UMLTestCase {
    ...
    public DPD_Artifact(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_Artifact.class);
        return suite;
    }
...
/**
 * @caseblock Artifact Symbol
 * @usecase Lock edit of a Artifact
 */
 ...
 */
    public void testSelectAllSimilar() throws NotFoundException {
        boolean result = verifier.checkSelectAllSimilar(new ElementTypes[]{ElementTypes.ARTIFACT, ElementTypes.COMPONENT});
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
...
/**
 * @caseblock Artifact Symbol
 * @usecase Text color of a Artifact
 */
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new DiagramElementVerifier(diagram, ElementTypes.ARTIFACT, "", getLog());
    }
