...
public class SQDActorPropertiesTests extends UMLTestCase {
    
        
    public SQDActorPropertiesTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(SQDActorPropertiesTests.class);
        return suite;
    }
        
        
    /******************const section*************************/
    private String PROJECT_NAME = "SQD_umlAPT";      
    ...
    public void testCheckStereotypes(){
        ...
        boolean editable = false;                
            ...
            PropertyVerifier custom = new PropertyVerifier(PROPS_NAME){                
                protected boolean setNewValue(String propertyName, String newValue){                    
                    Property prop = new Property(properties, propertyName);
                    new CustomPropertiesHelper().addStereotype("ster", prop);
                    return true;
                }                
            };
