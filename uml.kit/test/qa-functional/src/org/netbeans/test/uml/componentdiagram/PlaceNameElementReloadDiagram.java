...
public class PlaceNameElementReloadDiagram extends UMLTestCase {
    ...
    private static String prName= "ComponentDiagramProjectPSO";
...
/* private static String diagramName15 = "cpD15";
    ...
    public PlaceNameElementReloadDiagram(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.componentdiagram.PlaceNameElementReloadDiagram.class);  
        return suite;
    }
    ...
    public void testCreateAndCheckAfterReopen1() {
        ...
        testPlaceNameReopen(workPkg1,diagramName1,element1,elementName1,elementType1);
    }
    public void testCreateAndCheckAfterReopen2() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg2,diagramName2,element2,elementName2,elementType2);
    }
    public void testCreateAndCheckAfterReopen3() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg3,diagramName3,element3,elementName3,elementType3);
    }
    public void testCreateAndCheckAfterReopen4() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg4,diagramName4,element4,elementName4,elementType4);
    }
    public void testCreateAndCheckAfterReopen5() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg5,diagramName5,element5,elementName5,elementType5);
    }
    public void testCreateAndCheckAfterReopen6() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg6,diagramName6,element6,elementName6,elementType6);
    }
    public void testCreateAndCheckAfterReopen7() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg7,diagramName7,element7,elementName7,elementType7);
    }
    public void testCreateAndCheckAfterReopen8() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg8,diagramName8,element8,elementName8,elementType8);
    }
    public void testCreateAndCheckAfterReopen9() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg9,diagramName9,element9,elementName9,elementType9);
    }
    public void testCreateAndCheckAfterReopen10() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg10,diagramName10,element10,elementName10,elementType10);
    }
   public void testCreateAndCheckAfterReopen11() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg11,diagramName11,element11,elementName11,elementType11);
    }
   public void testCreateAndCheckAfterReopen12() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg12,diagramName12,element12,elementName12,elementType12);
    }
   public void testCreateAndCheckAfterReopen13() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg13,diagramName13,element13,elementName13,elementType13);
    }
   public void testCreateAndCheckAfterReopen14() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg14,diagramName14,element14,elementName14,elementType14);
    }
   public void testCreateAndCheckAfterReopen15() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg15,diagramName15,element15,elementName15,elementType15);
    }
   public void testCreateAndCheckAfterReopen16() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg16,diagramName16,element16,elementName16,elementType16);
    }
   public void testCreateAndCheckAfterReopen17() {
        lastTestCase=getCurrentTestMethodName();
        testPlaceNameReopen(workPkg17,diagramName17,element17,elementName17,elementType17);
    }
   ...
   private void testPlaceNameReopen(String workPkg,String diagramName,String element,String elementName,ElementTypes elementType,String newName)
   {
       ...
       //
        ...
        d.closeWindow();
        //
        d = createOrOpenDiagram(project,workPkg, diagramName);
        //
   ...
   private void testPlaceNameReopen(String workPkg,String diagramName,String element,String elementName,ElementTypes elementType)
   {
       testPlaceNameReopen(workPkg,diagramName,element,elementName,elementType,"ElName");
   }
