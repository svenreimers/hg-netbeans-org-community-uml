...
/*
 * CLD_UsageLinkTests.java
 *
 * Created on May 13, 2005, 4:33 PM
 *
 ...
 *
 */
public class CLD_UsageLinkTests extends ClassDiagramTestCase {
    
    private static String prName = "UMLProjectForUsageLink";
    private static String dpdName = "ClassDiagramForUsageLink";
   ...
   //  private static final String workDir = "I:/UML_TEMP" ;
    ...
    public CLD_UsageLinkTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.classdiagram.CLD_UsageLinkTests.class);
        return suite;
    }
...
//------------------------------------------------------------------------------    
    ...
    public void testSelectAllByPopup() throws NotFoundException {
        boolean result = verifier.checkSelectAllByPopup(ElementTypes.CLASS, ElementTypes.NODE, LinkTypes.USAGE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
    ...
    public void testInvertSelection() throws NotFoundException {
        boolean result = verifier.checkInvertSelection(ElementTypes.CLASS, ElementTypes.ARTIFACT, LinkTypes.USAGE);
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new LinkVerifier(diagram, LinkTypes.USAGE, "CLD_", getLog());
    }
