...
public class ClassDiagramAdditionalTests extends UMLTestCase {
    private final String projectName = "Depend_uml_cldAdd";
    ...
    public ClassDiagramAdditionalTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(ClassDiagramAdditionalTests.class);
        return suite;
    }
...
/**
     ...
     */
    public void testAddNewClassOnDependencyDiagram(){
        verifier.testAddNewClassOnDependencyDiagram(projectName);
    }
...
/**
     ...
     */
    public void testModifiedDependencySaving(){
        verifier.testModifiedDependencySaving(projectName);
    }
