...
public class BasicOptions extends UMLTestCase {
    ...
    public BasicOptions(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.pref.BasicOptions.class);
        return suite;
    }
    ...
    public void testBasic() {
        ...
        OptionsOperator opW=new OptionsOperator();
        JLabelOperator umlBtn=new JLabelOperator(opW,"UML");
        umlBtn.clickMouse();
        new JLabelOperator(opW,"UML Options");
        try{Dumper.dumpComponent(opW.getSource(),"c:/op.xml");}catch(Exception ex){};
    }
