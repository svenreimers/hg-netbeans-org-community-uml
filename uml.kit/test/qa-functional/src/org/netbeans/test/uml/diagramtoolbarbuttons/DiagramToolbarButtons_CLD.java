...
public class DiagramToolbarButtons_CLD extends UMLTestCase {
    ...
    public DiagramToolbarButtons_CLD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramtoolbarbuttons.DiagramToolbarButtons_CLD.class);
        return suite;
    }
 ...
 */
    public void testBtn_SequenceLayout(){
        ...
        try
        {
            ...
            fail("unexpected "+btnTooltipName+" on class diagram.");
        }
        catch(Exception ex)
        {
            //good
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DTBUtils.openDiagram(prName, cldName, NewDiagramWizardOperator.CLASS_DIAGRAM, workDir);
        if (diagram == null){
