...
public class DPD_Package extends UMLTestCase {
    
    private static String prName = "UMLProjectDPD3";
    ...
    public DPD_Package(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_Package.class);
        return suite;
    }
...
/**
 * @caseblock Package Symbol
 * @usecase Lock edit of a Package
 */
 ...
 */
    public void testSelectAllSimilar() throws NotFoundException {
        boolean result = verifier.checkSelectAllSimilar(new ElementTypes[]{ElementTypes.PACKAGE, ElementTypes.COMPONENT});
        if (!result){
            fail("Test failed. Details in log file.");
        }
    }
...
/**
 * @caseblock Package Symbol
 * @usecase Text color of a Package
 */
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new DiagramElementVerifier(diagram, ElementTypes.PACKAGE, "", getLog());
    }
