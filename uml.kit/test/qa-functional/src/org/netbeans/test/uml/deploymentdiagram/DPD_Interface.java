...
public class DPD_Interface extends UMLTestCase {
    ...
    public DPD_Interface(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.deploymentdiagram.DPD_Interface.class);
        return suite;
    }
...
/**
 * @caseblock Interface Symbol
 * @usecase Lock edit of a Interface
 */
...
/**
 * @caseblock Interface Symbol
 * @usecase Text color of a Interface
 */
...
//------------------------------------------------------------------------------
    ...
    protected void setUp() throws FileNotFoundException{
        ...
        verifier =  new DiagramElementVerifier(diagram, ElementTypes.INTERFACE, "", getLog());
    }
