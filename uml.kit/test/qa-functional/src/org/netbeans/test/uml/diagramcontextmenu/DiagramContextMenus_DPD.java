...
public class DiagramContextMenus_DPD extends UMLTestCase {
    ...
    public DiagramContextMenus_DPD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramcontextmenu.DiagramContextMenus_DPD.class);
        return suite;
    }
 ...
 * @usecase Check context menu of deployment diagram
 */
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DCMUtils.openDiagram(prName, dpdName, NewDiagramWizardOperator.DEPLOYMENT_DIAGRAM, workDir);
        if (diagram == null){
