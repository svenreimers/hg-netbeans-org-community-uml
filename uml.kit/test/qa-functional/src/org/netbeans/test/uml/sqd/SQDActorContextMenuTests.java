...
public class SQDActorContextMenuTests  extends UMLTestCase {
    
    public SQDActorContextMenuTests(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(SQDActorContextMenuTests.class);
        return suite;
    }
        
        
    /******************const section*************************/
    private String PROJECT_NAME = "SQD_umlACMT";      
    ...
    private DiagramElementOperator createWorkingElement(String lineName, String className) throws NotFoundException{
        dia.putElementOnDiagram(lineName+":"+className, ElementTypes.ACTOR_LIFELINE);
        DiagramElementOperator el = new LifelineOperator(dia, lineName, className);
        return el;
    }
