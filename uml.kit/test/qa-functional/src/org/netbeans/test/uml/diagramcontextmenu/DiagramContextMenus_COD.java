 ...
 */
public class DiagramContextMenus_COD extends UMLTestCase {
    private static String prName = "UMLProjectDCntMn";
    private static String codName = "DCollaboration";
    ...
    public DiagramContextMenus_COD(String name) {
        super(name);
    }
    
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.diagramcontextmenu.DiagramContextMenus_COD.class);
        return suite;
    }
...
//------------------------------------------------------------------------------
    ...
    public void setUp() throws FileNotFoundException{
        ...
        diagram = DCMUtils.openDiagram(prName, codName, NewDiagramWizardOperator.COLLABORATION_DIAGRAM, workDir);
        if (diagram == null){
            fail("Can't open diagram '" + codName + "', project '" + prName + "'.");
        }
    }
