 ...
 */
public class ActivityDiagramTreeProps extends UMLTestCase {
    ...
    private static String prName= "ActivityDiagramProjectTP";
    ...
    public ActivityDiagramTreeProps(String name) {
        super(name);
    }
     public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(org.netbeans.test.uml.activitydiagram.ActivityDiagramTreeProps.class);
        return suite;
    }
    ...
    public void testProp21() {
         testElementInTreeProperties("c_"+workPkg1,activityDiagramName1,element1,elementName1,elementType1);
    }
    public void testProp22() {
         testElementInTreeProperties("c_"+workPkg2,activityDiagramName2,element2,elementName2,elementType2);
    }
    public void testProp23() {
         testElementInTreeProperties("c_"+workPkg3,activityDiagramName3,element3,elementName3,elementType3);
    }
    public void testProp24() {
         testElementInTreeProperties("c_"+workPkg4,activityDiagramName4,element4,elementName4,elementType4);
    }
    public void testProp25() {
         testElementInTreeProperties("c_"+workPkg5,activityDiagramName5,element5,elementName5,elementType5);
    }
    public void testProp26() {
        testElementInTreeProperties("c_"+workPkg6,activityDiagramName6,element6,elementName6,elementType6);
    }
    public void testProp27() {
         testElementInTreeProperties("c_"+workPkg7,activityDiagramName7,element7,elementName7,elementType7);
    }
    public void testProp28() {
         testElementInTreeProperties("c_"+workPkg8,activityDiagramName8,element8,elementName8,elementType8);
    }
    public void testProp29() {
        testElementInTreeProperties("c_"+workPkg9,activityDiagramName9,element9,elementName9,elementType9);
    }
    public void testProp30() {
         testElementInTreeProperties("c_"+workPkg10,activityDiagramName10,element10,elementName10,elementType10);
    }
   public void testProp31() {
         testElementInTreeProperties("c_"+workPkg11,activityDiagramName11,element11,elementName11,elementType11);
    }
   public void testProp32() {
         testElementInTreeProperties("c_"+workPkg12,activityDiagramName12,element12,elementName12,elementType12);
    }
   public void testProp33() {
        testElementInTreeProperties("c_"+workPkg13,activityDiagramName13,element13,elementName13,elementType13);
    }
   public void testProp34() {
        testElementInTreeProperties("c_"+workPkg14,activityDiagramName14,element14,elementName14,elementType14);
    }
   ...
   private void testElementInTreeProperties(String workPkg,String diagramName,String element,String elementName,ElementTypes elementType)
   {
        lastTestCase=getCurrentTestNamesWithCheck()[1];
       testElementPlace(workPkg,diagramName+"_prop",element,elementName,elementType);
       Node de=new Node(lastDiagramNode,lastDiagramNode.getChildren().length-1);
        new EventTool().waitNoEvent(500);
        de.select();
        new EventTool().waitNoEvent(500);
        PropertySheetOperator ps=new PropertySheetOperator();
        String propTtl=elementType+" - Properties";
        if(elementName.length()>0)propTtl=elementName+" - Properties";
         assertTrue("Property sheet isn't for "+elementType+" selected in tree, but with title "+ps.getName(),propTtl.equals(ps.getName()));
    }
