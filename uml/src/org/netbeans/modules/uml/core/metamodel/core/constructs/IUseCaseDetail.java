...
public interface IUseCaseDetail extends INamedElement
{
    ...
    public void removeSubDetail(IUseCaseDetail subDetail);
    public void addSubDetail(IUseCaseDetail subDetail);
    public String getBody();
    public void setBody(String body);
    public IUseCaseDetail getParentDetail();
    public void setParentDetail(IUseCaseDetail parentDetail);
