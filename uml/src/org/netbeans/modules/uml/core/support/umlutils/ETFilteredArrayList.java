...
/*
	...
	{
		m_instanceOfTypeName = dummy;
	}
	
	public boolean add(TypeName o)
	{
		if (o != null && o.getClass().isInstance(m_instanceOfTypeName))
			return super.add(o);
		else
			return false;
	}
	
	public boolean addAll(List<TypeName> c)
	{
		if (c == null)
			return false;
			
		Iterator<TypeName> iter = c.iterator();
		while (iter.hasNext())
		{
			add(iter.next());
		}
