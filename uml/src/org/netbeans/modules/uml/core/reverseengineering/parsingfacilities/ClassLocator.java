...
public class ClassLocator extends LocatorEvaluator<IREClass>
{
    ...
    public ClassLocator(String desiredClass)
    {
...
/**
     ...
     */
    public IREClass findElement(IREClass thisClass, IREClassLoader loader,
                                IREClass element)
    {
        if (thisClass == null) return null;
        
        return m_DesiredClass != null 
                && m_DesiredClass.equals(thisClass.getName())?
                             thisClass : null;
    }
}
