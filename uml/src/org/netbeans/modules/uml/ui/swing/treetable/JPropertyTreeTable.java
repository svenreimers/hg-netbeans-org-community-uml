...
/**
	...
	public JPropertyTreeTable(TreeTableModel treeTableModel, PropertyEditor editor)
	{
		...
		colMod.getColumn(0).setMinWidth(20);
		colMod.getColumn(0).setMaxWidth(20);
		...
		this.addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent e) 
			{
				if (e.getKeyCode() == KeyEvent.VK_RIGHT || e.getKeyCode() == KeyEvent.VK_LEFT ||
					e.getKeyCode() == KeyEvent.VK_INSERT || e.getKeyCode() == KeyEvent.VK_DELETE ||
	...
	{
		//we do not want the columns/cells to be dragged, so just consume this event for Propety Editor.
		e.consume();
	}
...
/**
	...
	{
		m_editor.startEditingRowAt(row);
		m_CurRow = row;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (srcText.equals(PropertyEditorResources.getString("PropertyEditor.Navigate_Menu")))
		{
			m_editor.onPopupNavigate();
		}
		else if (srcText.equals(PropertyEditorResources.getString("PropertyEditor.Fill_Down_Menu")))
		{
			m_editor.onPopupFill();
		}
	}
