...
public class ColorProperty extends DrawingProperty implements IColorProperty
{
	...
	public void initialize(IDrawingPropertyProvider provider, String sDrawEngineName, String sResourceName, int colorRef)
	{
		if (provider != null)
		{
			setDrawingPropertyProvider(provider);
		}

		if (sDrawEngineName != null && sDrawEngineName.length() > 0 && sResourceName != null && sResourceName.length() >0)
		{
