 ...
 */
public class ReadLinkActionTestCase extends AbstractUMLTestCase
{
    public static void main(String[] args)
    {
        junit.textui.TestRunner.run(ReadLinkActionTestCase.class);
    }
...
/* (non-Javadoc)
    ...
    {
        super.setUp();
        act = (IReadLinkAction)FactoryRetriever.instance().createType("ReadLinkAction", null);
