...
public interface IAttributeChangeListener {
    ...
    public boolean attributeChanged(MemberInfo oldC, MemberInfo newC,
                                    boolean beforeChange);

    public boolean attributeDeleted(MemberInfo clazz, boolean beforeChange);
    
    public boolean attributeDuplicated(MemberInfo oldMember, MemberInfo newMember,
            boolean before);
}
