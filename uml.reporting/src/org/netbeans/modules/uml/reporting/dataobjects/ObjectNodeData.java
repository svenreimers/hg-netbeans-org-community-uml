...
public class ObjectNodeData extends ActivityNodeData
{
    ...
    /** Creates a new instance of ObjectNodeData */
    ...
    {
        if (e instanceof IObjectNode)
            this.element = (IObjectNode)e;
    }
    
    public IObjectNode getElement()
    {
        return element;
    }
    ...
    protected Object[] getPropertyValues()
    {
        ...
        NbBundle.getMessage(SignalNodeData.class, "ObjectNodeOrdering" +
                getElement().getOrdering())};
    }
}
