...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        projectList.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(DoorsProjectDialog.class, "ACSN_PROJECT_LIST")); // NOI18N
        projectList.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(DoorsProjectDialog.class, "ACSD_PROJECT_LIST")); // NOI18N

        projectListLabel.setLabelFor(projectList);
        org.openide.awt.Mnemonics.setLocalizedText(projectListLabel, org.openide.util.NbBundle.getMessage(DoorsProjectDialog.class, "LBL_DoorsProjects")); // NOI18N
        ...
        projectListLabel.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(DoorsProjectDialog.class, "ACSD_PROJECT_LIST")); // NOI18N
