...
public class PaletteConnectAction extends WidgetAction.Adapter
{
    ...
    public PaletteConnectAction(ConnectDecorator decorator, 
                                Widget interractionLayer, 
                                ExConnectProvider provider, 
                                Widget source)
    {
    ...
    protected void initialize()
    {
        ...
        if (provider.isSourceWidget(sourceWidget))
        {
            targetWidget = null;
            connectionWidget = decorator.createConnectionWidget(interractionLayer.getScene());
            assert connectionWidget != null;
            connectionWidget.setSourceAnchor(decorator.createSourceAnchor(sourceWidget));
