...
public class ContextPaletteConnectDecorator implements ConnectDecorator
{
    ...
    {
        Widget source = sourceWidget;
        if(sourceWidget instanceof RapidButton)
        {
            RapidButton btn = (RapidButton)sourceWidget;
            source = btn.getAssociatedWidget();
        }
        return AnchorFactory.createRectangularAnchor(source);
    }

    public Anchor createTargetAnchor(Widget targetWidget)
    {
        return AnchorFactory.createRectangularAnchor(targetWidget);
    }
