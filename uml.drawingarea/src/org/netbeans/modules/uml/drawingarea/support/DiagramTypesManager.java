...
//                Node n = m_Doc.selectSingleNode(query);
                    ...
                    Node n = (Node) xpath.evaluate(query, m_Doc, XPathConstants.NODE);
                    if (n instanceof org.w3c.dom.Element) {
                        Element element = (Element) n;
                        String value = element.getAttribute(attributeToFind);
...
//        if (m_Doc == null) { //Jyothi: TODO: commented this out to avoid exceptions
            ...
            if (location.length() > 0) {
                try {
                    m_Doc = new InputSource(new FileInputStream(location));
            ...
            if (m_Doc != null) {
                try
                {
                    ...
                    if (n instanceof Element) {
                        Element element = (Element)n;
                        retVal = element.getAttribute(attributeToFind);
                    }
                }
                catch(Exception e)
                {
