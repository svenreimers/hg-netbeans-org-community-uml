...
import org.netbeans.modules.uml.drawingarea.persistence.SaveDiagram;
...
public class UMLDiagramDataObject extends MultiDataObject {

    FileObject diagFO;
    transient private UMLDiagramEditorSupport diagramEditor;
    transient private OpenViewEdit openViewEdit;
    
    public UMLDiagramDataObject(FileObject pf, UMLDiagramDataLoader loader) 
            throws DataObjectExistsException, IOException 
    {
        super(pf, loader);
        this.diagFO = pf;
        registerEntry(diagFO);
    ...
    public EditorCookie createEditorCookie() {
        return new UMLDiagramEditorSupport(this);
    }
    ...
    {
        return !diagFO.canWrite();
    }

    
    public synchronized UMLDiagramEditorSupport getDiagramEditorSupport()
    {
        if (diagramEditor == null)
        {
            diagramEditor = new UMLDiagramEditorSupport(this);
        }
        return diagramEditor;
    }
    
    
    public UMLDiagramEditorSupport getDiagramEditor()
    {
