...
{   
    private ContextPaletteDataObject itemDataObject;

    private Node data = null;
    
    ContextPaletteItem(ContextPaletteDataObject dobj)
    {
        itemDataObject = dobj;
    }
    ...
    {
        return itemDataObject.getElementType();
    }
    ...
    protected Node getData()
    {
        if(data == null)
        {
            data = itemDataObject.createNodeDelegate();
        }
