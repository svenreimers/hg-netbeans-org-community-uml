...
public class UMLDiagramEditorSupport extends DataEditorSupport 
    ...
    private UMLDiagramDataObject diagramDataObject;

    public UMLDiagramEditorSupport(UMLDiagramDataObject obj) {
        super(obj, new UMLDiagramEditorEnv(obj));
    ...
    private static class UMLDiagramEditorEnv extends DataEditorSupport.Env {

//            private static final long serialVersionUID = 1L;
        public UMLDiagramEditorEnv(DataObject obj) {
            super(obj);
        }
        ...
        public CloneableOpenSupport findCloneableOpenSupport() {
            return (CloneableOpenSupport) getDataObject().getCookie(UMLDiagramEditorSupport.class);
