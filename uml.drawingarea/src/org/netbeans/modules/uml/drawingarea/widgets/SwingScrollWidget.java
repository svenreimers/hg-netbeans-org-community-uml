...
public class SwingScrollWidget extends Widget {
    ...
    private final class ScrollLayout implements Layout {
        ...
        public void layout (Widget widget) {
            ...
            boolean viewBoundsChanged = false;
            if(viewBounds.getWidth() < viewportBounds.getWidth())
            {
                viewBounds.width = viewportBounds.width;
                viewBoundsChanged = true;
            }
            
            if(viewBounds.getHeight() < viewportBounds.getHeight())
            {
            ...
            {
                view.setPreferredBounds(viewBounds);
            }
