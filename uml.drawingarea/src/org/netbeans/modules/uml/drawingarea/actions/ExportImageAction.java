...
public class ExportImageAction extends AbstractAction
{
    ...
    private static ExportImagePanel panel = new ExportImagePanel();
    
    public ExportImageAction(DesignerScene scene)
    {
        this.scene = scene;
    ...
    {
        String title = NbBundle.getMessage(ExportImageAction.class, "TITLE_ExportImage"); // NOI18N
