...
public class CustomizableWidget extends Widget implements Customizable {
    ...
    public CustomizableWidget(Scene scene, String id, String name)
    {   
//            super(scene);
//        widgetName = name;
//        this.id = id;
...
//        ResourceValue.initResources(id, this);
    ...
    public CustomizableWidget(Scene scene, String id, String name, ResourceTable table)
    {
        super(scene);
        widgetName = name;
        this.id = id;
    ...
    public void setUseGradient(boolean val)
    {
        useGradient = val;
    }
