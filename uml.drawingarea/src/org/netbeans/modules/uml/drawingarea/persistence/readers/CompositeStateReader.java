...
public class CompositeStateReader implements GraphNodeReader
{
    ...
    public CompositeStateReader(NodeInfo nodeInfo)
    {
    ...
    public void processGraphNode(GraphNodeReader peek, NodeInfo nodeInfo)
    {
        ...
        else if (peek instanceof CompositeStateReader)
        {
            ...
            if (widget != null && widget instanceof DiagramNodeReader)
            {
                ...
                if (peek.getNodeInfo().getModelElement() instanceof IRegion)
                {
                    addNodeToScene(widget, nodeInfo);
                }
            }
        } else
        {
