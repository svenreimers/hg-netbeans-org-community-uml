...
public class DIEdgeWriter extends EdgeWriter {
    ...
    //need to overide methods to match the DI spec
    public void beginGraphEdge() {
        DIXMIWriter.writeElement(bw, XMIConstants.UML_GRAPHEDGE, getEdgeAttrs());

        //write graph element position
        DIXMIWriter.writeGraphElementPosition(bw, "GRAPHELEMENT", location);
        //write graph edge way points
        DIXMIWriter.writeEdgeWayPoints(bw, wayPoints);
        //write graph elemnet symantic model
        DIXMIWriter.writeSymanticModelBridge(bw, getSymanticModelBridgeAttrs(), elementType, MEID);
    //write contained.
    //write edge anchors
    }

    public void endGraphEdge() {
        DIXMIWriter.writeEndElement(bw, XMIConstants.UML_GRAPHEDGE);
    }

    public void writeEdgeAnchors() {
        //begin anchor tag
        DIXMIWriter.writeBeginElement(bw, XMIConstants.UML_GRAPHEDGE_ANCHORS);
        //write source anchor
        DIXMIWriter.writeEmptyElement(bw, XMIConstants.UML_GRAPHCONNECTOR, getConnectorAttrs(srcAnchorID));
        //write target anchor
        DIXMIWriter.writeEmptyElement(bw, XMIConstants.UML_GRAPHCONNECTOR, getConnectorAttrs(targetAnchorID));
        //end anchor tag
        DIXMIWriter.writeEndElement(bw, XMIConstants.UML_GRAPHEDGE_ANCHORS);
    }

    public void writeComment(String str) {
        DIXMIWriter.writeComment(bw, str);
    }
