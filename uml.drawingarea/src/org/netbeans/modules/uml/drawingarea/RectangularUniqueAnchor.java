...
public final class RectangularUniqueAnchor extends Anchor
{
    ...
    public RectangularUniqueAnchor(Widget widget, boolean includeBorders)
    {
        super(widget);
...
//                return new Anchor.Result(relatedLocation, Anchor.DIRECTION_ANY);
        ...
        for (int a = 0; a < len; a ++)
        {
            ...
            results.put (curEntry, new Result (new Point (x, y), Direction.RIGHT));
        }
        ...
        for (int a = 0; a < len; a ++)
        {
            ...
            int y = bounds.y + (a + 1) * bounds.height / (len + 1);
            results.put (curEntry, new Result (new Point (x, y), Direction.LEFT));
        }
        ...
        for (int a = 0; a < len; a ++)
        {
            ...
            results.put (curEntry, new Result (new Point (x, y), Direction.TOP));
        }
        ...
        for (int a = 0; a < len; a ++)
        {
            ...
            x = bounds.x + (a + 1) * bounds.width / (len + 1);
            results.put (curEntry, new Result (new Point (x, y), Direction.BOTTOM));
        }
